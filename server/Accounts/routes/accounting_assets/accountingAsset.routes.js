...
const {
    addAccountingAsset, getAllAccountingAssets, getAccountingAsset,
    editAccountingAsset, deleteAccountingAsset,
} = require('../../controllers/accounting_assets/accountingAssets.controller');
