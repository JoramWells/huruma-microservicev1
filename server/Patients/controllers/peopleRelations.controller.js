...
const PeopleRelations = require('../models/peopleRelations.model');
...
const addPeopleRelations = async (req, res, next) => {
  try {
    const newProfile = await PeopleRelations.create(req.body);
...
const getAllPeopleRelations = async (req, res, next) => {
  ...
  try {
    ...
    const { rows, count } = await PeopleRelations.findAndCountAll({
      page,
      pageSize,
      limit,
      offset,
...
const getPeopleRelationDetail = async (req, res, next) => {
  const { id } = req.params;
  try {
    const PeopleRelation = await PeopleRelations.findOne({
      where: {
        id,
      },
    });
...
const editPeopleRelation = async (req, res, next) => {
  ...
  try {
    const result = await PeopleRelations.findOne({
      where: {
...
const deletePeopleRelation = async (req, res, next) => {
  const { id } = req.params;
  try {
    const results = await PeopleRelations.destroy({
      where: {
        PeopleRelation_id: id,
      },
    });
