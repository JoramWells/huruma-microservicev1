...
const { addInternalLabRequest, getAllInternalLabRequests, getInternalLabRequest,
  ...
  getAllInternalLabRequestsByAppointmentID } = require('../../controllers/_lab/internalLabRequests.controller');
...
router.get('/by-appointment-id/:id', getAllInternalLabRequestsByAppointmentID);
