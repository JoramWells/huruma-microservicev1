...
const {
    addAccountingCostCentre, getAllAccountingCentres, getAccountingCostCentreDetail,
    editAccountingCostCentre, deleteAccountingCostCentre,
} = require('../controllers/accountingCostCentres.controller');
